...
class WpAssetManager extends AssetManager
{
	...
	public function getMergedCoreJavaScript() {
		$path = rtrim( plugin_dir_path( PSSTATS_ANALYTICS_FILE ), '/' ) . '/assets/js';
	...
	public function getJsInclusionDirective()
	{
		...
		// $result .= sprintf(self::JS_IMPORT_DIRECTIVE, plugins_url( 'assets/js/asset_manager_core_js.js', PSSTATS_ANALYTICS_FILE )  . '?v=' . Version::VERSION);
