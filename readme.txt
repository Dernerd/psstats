=== Psstats Analytics - Ethical Stats. Powerful Insights. ===
Contributors: psstatsteam
...
Psstats is the #1 Google Analytics alternative that gives you full control over your data and protects user privacy. Free, secure, and open.

== Description ==

If you are already using Psstats On-Premise (formerly Piwik) or Psstats Cloud, please use the [WP-Psstats plugin](https://wordpress.org/plugins/wp-piwik/). 
...
Psstats Analytics is the #1 used Google Analytics alternative that offers a powerful range of features, security and protects the privacy of your users. This enables you to learn how to improve your website, make the right decisions for your business and stand out in the crowd in a safe and trustworthy way.

Psstats’s mission is to give control and data ownership back to the user. By hosting web analytics on your own servers there’s no third-parties taking ownership, no on-selling of data and no-one looking in. This means when you install Psstats in a matter of a few clicks, you’re in full control.

It’s also easier for you to get insights from Psstats Analytics with it’s time-saving interface design and out-of-the-box features, which require less manual configuration than Google Analytics.

Psstats is free, secure and open - your ethical user insights platform.



**How Psstats Analytics for Wordpress solves problems:**
...
* Comes equipped with Psstats Tag Manager

**How Psstats focuses on privacy:**
...
Running Psstats Analytics on your server can use significant resources. Whenever someone visits your WordPress website, your server will need to serve your WordPress pages to the user, as well as tracking the user journey in Psstats, resulting in an additional request for each page view.
...
* Go to "Psstats Analytics" in the WordPress Admin Dashboard.
...
= Does Psstats care about security?
...
The Tag Manager can be disabled by placing `define('PSSTATS_ENABLE_TAG_MANAGER', false);` in your `wp-config.php`.
...
* Admin: The Psstats UI does not support IE9 or older.
...
1. Customizable Psstats Dashboard. Choose from many widgets and adjust layout.
...
7. Easily give your co-workers access to your Psstats reports.
