...
class Woocommerce extends Base {
	...
	public function register_hooks() {
		...
		if (!$this->should_track_background()) {
			// prevent possibly executing same event twice where eg first a PHP Psstats tracker request is created
	...
	public function on_product_view() {
		...
		echo $this->wrap_script( $this->make_psstats_js_tracker_call( $params ) );
	}
