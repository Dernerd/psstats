(function() {
    ...
    function update_status() {
        if (are_cookies_disabled()) {
            set_display('psstats_outout_err_cookies', 'block');
            set_display('psstats_optout_checkbox', 'none');
        } else if (is_opted_out()) {
            set_display('psstats_opted_out_intro', 'block');
            set_display('psstats_opted_in_intro', 'none');
            set_display('psstats_opted_out_label', 'inline');
            set_display('psstats_opted_in_label', 'none');
            by_id('psstats_optout_checkbox').checked = false;
        } else {
            set_display('psstats_opted_out_intro', 'none');
            set_display('psstats_opted_in_intro', 'block');
            set_display('psstats_opted_out_label', 'none');
            set_display('psstats_opted_in_label', 'inline');
            by_id('psstats_optout_checkbox').checked = true;
        }
    }
    ...
    on_ready(function() {
        ...
        listen_event(by_id('psstats_optout_checkbox'), 'change', function() {
            var trackers = [];
