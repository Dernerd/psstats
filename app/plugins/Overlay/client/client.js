var Psstats_Overlay_Client = (function() {
    ...
    function loadJQuery(callback) {
        if (typeof jQuery != 'undefined') {
            ...
            Psstats_Overlay_Client.loadScript('../../../../../../../wp-includes/js/jquery/jquery.js', function() {
                $ = jQuery;
                jQuery.noConflict();
                callback();
            });
    ...
    return {
        ...
        api: function(method, callback, additionalParams) {
            ...
            var psstatsFrame = window.parent;
            psstatsFrame.postMessage('overlay.call:' + requestId + ':' + encodeURIComponent(url), piwikOrigin);
        },
        ...
        loadingNotification: function(message) {
            return Psstats_Overlay_Client.notification(message, 'Loading');
        }
