var Piwik_Overlay_FollowingPages = (function() {
    ...
    function load(callback) {
        ...
        Psstats_Overlay_Client.api('getExcludedQueryParameters', function(data) {
        ...
        Psstats_Overlay_Client.api('getFollowingPages', function(data) {
            followingPages = data;
    ...
    function highlightLink(linkTag, linkUrl, data) {
        ...
        Psstats_Overlay_Client.hideNotifications('LinkLocation');

        // we don't use .data() because jquery would remove the callback when the link tag is removed
        linkTag[0].piwikHideNotification = Psstats_Overlay_Client.notification(
    ...
    return {
        ...
        initialize: function(finishCallback) {
            c = Psstats_Overlay_Client.createElement;
            Psstats_Overlay_Client.loadScript('plugins/Overlay/client/urlnormalizer.js', function() {
