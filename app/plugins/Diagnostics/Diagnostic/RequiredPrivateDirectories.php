...
/**
 * Checks whether certain directories in Psstats that should be private are accessible through the internet.
 */
class RequiredPrivateDirectories implements Diagnostic
{
    ...
    public function execute()
    {
        ...
        $privatePaths = [
            ['tmp/', 'tmp/empty', 'tmp/cache/tracker/psstatscache_general.php'], // tmp/empty is created by this diagnostic
            ['.git/', '.git/config'],
            ['lang/en.json'],
        ];
        ...
        if ($atLeastOneIsAccessible) {
            ...
            $pathIsAccessible .= '<br/><br/><a href="https://psstats.org/faq/troubleshooting/how-do-i-fix-the-error-private-directories-are-accessible/" target="_blank" rel="noopener noreferrer">' . $this->translator->translate('General_ReadThisToLearnMore', ['', '']) . '</a>';
