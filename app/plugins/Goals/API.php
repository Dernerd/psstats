 ...
 *
 * If you are <a href='http://psstats.org/docs/ecommerce-analytics/' target='_blank'>tracking Ecommerce orders and products</a> on your site, the functions "getItemsSku", "getItemsName" and "getItemsCategory"
 ...
 *
 * See also the documentation about <a href='http://psstats.org/docs/tracking-goals-web-analytics/' rel='noreferrer' target='_blank'>Tracking Goals</a> in Psstats.
 *
...
class API extends \Piwik\Plugin\API
{
    ...
    protected function getItems($recordName, $idSite, $period, $date, $abandonedCarts, $segment)
    {
        ...
        // Before Psstats 4.0.0 ecommerce views were tracked in custom variables
        // So if Psstats was installed before try to fetch the views from custom variables and enrich the report
