...
/**
 * DBStats API is used to request the overall status of the Mysql tables in use by Psstats.
...
class API extends \Piwik\Plugin\API
{
    ...
    /**
     * Gets some general information about this Psstats installation, including the count of
    ...
    /**
     * Returns a datatable summarizing how data is distributed among Psstats tables.
     *
