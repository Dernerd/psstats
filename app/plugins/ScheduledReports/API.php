 ...
 * See also the documentation about <a href='http://psstats.org/docs/email-reports/' rel='noreferrer' target='_blank'>Scheduled Email reports</a> in Psstats.
 *
...
class API extends \Piwik\Plugin\API
{
    ...
    public function sendReport($idReport, $period = false, $date = false, $force = false)
    {
        ...
        Context::changeIdSite($report['idsite'], function () use ($report, $idReport, $period, $date, $force) {
             ...
             *                              report.
             * @param string $reportTitle The scheduled report's given title (given by a Psstats user).
    ...
    public static function getReportMetadata($idSite, $reportType)
    {
         ...
         * Triggered when gathering the list of Psstats reports that can be used with a certain
         * transport medium.
         *
         * Plugins that provide their own transport mediums should use this
         * event to list the Psstats reports that their backend supports.
         *
    ...
    public static function allowMultipleReports($reportType)
    {
         ...
         * handle sending multiple Psstats reports in one scheduled report or not.
         *
         * Plugins that provide their own transport mediums should use this
         * event to specify whether their backend can send more than one Psstats report
         * at a time.
         *
         * @param bool &$allowMultipleReports Whether the backend type can handle multiple
         *                                    Psstats reports or not.
         * @param string $reportType A string ID describing how the report is sent, eg,
         *                           `'sms'` or `'email'`.
         */
        Piwik::postEvent(
