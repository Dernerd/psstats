...
class CreatePull extends TranslationBase
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $message .= '\n\nHelp us translate Psstats in your language!\nSignup at https://www.transifex.com/psstats/psstats/\nIf you have any questions, get in touch with us at translations@psstats.org';
    ...
    private function createPullRequest(OutputInterface $output, $title, $message)
    {
        ...
        while (true) {
            ...
            $returnCode = shell_exec('curl \
                 ...
                 https://api.github.com/repos/psstats-org/psstats/pulls');
