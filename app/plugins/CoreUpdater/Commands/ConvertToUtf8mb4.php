...
class ConvertToUtf8mb4 extends ConsoleCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln("This command will convert all Psstats database tables to utf8mb4.\n");
        ...
        if ($yes) {
            ...
            if (!$keepTracking) {
                $output->writeln("\n" . Piwik::translate('Disabling Psstats Tracking'));
            ...
            if (!$keepTracking) {
                $output->writeln("\n" . Piwik::translate('Enabling Psstats Tracking'));
    ...
    {
        $output->writeln("To manually convert all Psstats database tables to utf8mb4 follow these steps.");
        if (!$keepTracking) {
            $output->writeln('');
            $output->writeln('** Disable Psstats Tracking with this command: **');
        ...
        if (!$keepTracking) {
            $output->writeln('');
            $output->writeln('** Enable Psstats Tracking again with this command: **');
