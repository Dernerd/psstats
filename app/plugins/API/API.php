...
/**
 * This API is the <a href='http://psstats.org/docs/analytics-api/metadata/' rel='noreferrer' target='_blank'>Metadata API</a>: it gives information about all other available APIs methods, as well as providing
 ...
 * </ul>
 * The Metadata API is for example used by the Psstats Mobile App to automatically display all Psstats reports, with translated report & columns names and nicely formatted values.
 * More information on the <a href='http://psstats.org/docs/analytics-api/metadata/' rel='noreferrer' target='_blank'>Metadata API documentation page</a>
 *
...
class API extends \Piwik\Plugin\API
{
     ...
     * @return string
     */
    public function getPsstatsVersion()
    {
                                      ...
                                      $showSubtableReports = false, $idSite = false)
    {
        if (empty($idSite) && !empty($idSites)) {
            ...
            throw new \Exception('Calling API.getReportMetadata without any idSite is no longer supported since Psstats 3.0.0. Please specify at least one idSite via the "idSite" parameter.');
        }
    ...
    /**
     * Get a list of all pages that shall be shown in a Psstats UI including a list of all widgets that shall
