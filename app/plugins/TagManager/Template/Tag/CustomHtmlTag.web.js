(function() {
    ...
    secureFilters.uri = function(val) {
        ...
        // modification by psstats: we use encodeURI instead of encodeURIComponent as we are currently not detecting
                ...
                for (var i = 0; i < variables.length; i++) {
                    ...
                    if (isVariable) {
                        if (TagManager.dom.isElementContext(value, 'script')) {
                            ...
                            value += 'window.PsstatsTagManager.customHtmlDataStore[' + (TagManager.customHtmlDataStore.length - 1) + ']';
