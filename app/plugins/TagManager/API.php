...
use Piwik\Plugins\TagManager\Template\Tag\PsstatsTag;
...
use Piwik\Plugins\TagManager\Template\Variable\PsstatsConfigurationVariable;
...
class API extends \Piwik\Plugin\API
{
     ...
     * to track a Psstats instance and also have a trigger assigned to track a pageview when a page is being viewed.
     *
     * While the Tag Manager creates this container by default for all new websites (measurables), it won't create
     * this container automatically for all previously existing websites if you have used Psstats before without the
    ...
    public function createDefaultContainerForSite($idSite)
    {
        ...
        $idVariable = Request::processRequest('TagManager.addContainerVariable', array(
            ...
            'type' => PsstatsConfigurationVariable::ID,
            'name' => Piwik::translate('TagManager_PsstatsConfigurationVariableName'),
        ), $default = []);
        ...
        $idTag = Request::processRequest('TagManager.addContainerTag', array(
            ...
            'parameters' => array(
                PsstatsTag::PARAM_PSSTATS_CONFIG => '{{'. Piwik::translate('TagManager_PsstatsConfigurationVariableName').'}}'
            )
        ), $default = []);
     ...
     * @param string $type The type of tag you want to create, for example "Psstats".
