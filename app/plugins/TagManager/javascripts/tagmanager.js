 ...
 * @source https://github.com/psstats-org/tag-manager/blob/master/js/piwik.js
 * @license https://psstats.org/free-software/bsd/ BSD-3 Clause (also in js/LICENSE.txt)
 */
...
(function() {
    ...
    if (typeof window.PsstatsTagManager !== 'object') {

        if (typeof window._mtm !== 'object') {
            window._mtm = [];
        }

        window.PsstatsTagManager = (function() {
                ...
                if (container.triggers && utils.isArray(container.triggers)) {
                    ...
                    if (container.tags && utils.isArray(container.tags)) {
                        ...
                        container.triggers.sort(function(a, b) {
                            var isABlockTrigger = false,
                                isBBlockTrigger = false,
                                tag, z;
            ...
            if ('psstatsTagManagerAsyncInit' in windowAlias && utils.isFunction(windowAlias.psstatsTagManagerAsyncInit)) {
                windowAlias.psstatsTagManagerAsyncInit();
            }
