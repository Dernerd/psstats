...
class TagManager extends \Piwik\Plugin
{
    ...
    public function registerEvents()
    {
        return array(
            ...
            'CustomJsTracker.trackerJsChanged' => 'regenerateReleasedContainers', // in case a Psstats tracker is bundled
    ...
    /**
     * Register the new tables, so Psstats knows about them.
     *
    ...
    public function getClientSideTranslationKeys(&$result)
    {
        ...
        $result[] = 'TagManager_NoPsstatsConfigFoundForContainer';
