...
class WebContext extends BaseContext
{
    ...
    public function generate($container)
    {
        ...
        foreach ($container['releases'] as $release) {
            ...
            $initContainer .= 'window.PsstatsTagManager.addContainer(' . json_encode($containerJs, $jsonOptions) . ', Templates);})()';
...
<!-- End Psstats Tag Manager -->
INST;

        return [[
            'description' => Piwik::translate('TagManager_ContextWebInstallInstructions', array('"<head>"')),
            'embedCode' => $embedCode,
            'helpUrl' => 'https://developer.psstats.org/guides/tagmanager/embedding'
        ]];
    }
