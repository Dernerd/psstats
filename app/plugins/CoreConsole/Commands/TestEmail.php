...
class TestEmail extends ConsoleCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $psstatsUrl = SettingsPiwik::getPiwikUrl();
        $body    = "Hello, world! <br/> This is a test email sent from $psstatsUrl";
        $subject = "This is a test email sent from $psstatsUrl";

        $mail = new Mail();
        $mail->setSmtpDebug(true);
        $mail->addTo($email, 'Psstats User');
