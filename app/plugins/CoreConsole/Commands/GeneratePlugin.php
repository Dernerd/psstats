    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($isTheme) {
            $this->writeSuccessMessage($output, array(
                ...
                'If you have not done yet check out our Theming guide <comment>https://developer.psstats.org/guides/theming</comment>',
                'Enjoy!'
            ));
        } else {
            $this->writeSuccessMessage($output, array(
                sprintf('Plugin %s %s generated.', $pluginName, $version),
                'Our developer guides will help you developing this plugin, check out <comment>https://developer.psstats.org/guides</comment>',
