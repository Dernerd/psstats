...
Header set Cache-Control \"Cache-Control: private, no-cache, no-store\"
    ...
    protected static function createHtAccess($path, $overwrite, $content)
    {
        ...
        $content = "# This file is auto generated by Psstats, do not edit directly\n# Please report any issue or improvement directly to the Psstats team.\n\n" . $content;
...
HTACCESS_ALLOW;
    ...
    /**
     * Deletes all existing .htaccess files and web.config files that Psstats may have created,
     */
