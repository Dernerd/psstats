...
class Controller extends \Piwik\Plugin\ControllerAdmin
{
    ...
    public function finished()
    {
        ...
        /**
         * Triggered on initialization of the form to customize default Psstats settings (at the end of the installation process).
         *
        ...
        if ($form->validate()) {
            try {
                /**
                 * Triggered on submission of the form to customize default Psstats settings (at the end of the installation process).
                 *
                 * @param \Piwik\Plugins\Installation\FormDefaultSettings $form
                 */
