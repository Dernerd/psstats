...
class TrackerUpdater
{
    ...
    const TARGET_PSSTATS_JS = '/psstats.js';
    ...
    public function __construct($fromFile = null, $toFile = null)
    {
        ...
        if (!isset($toFile)) {
            $toFile = PIWIK_DOCUMENT_ROOT . self::TARGET_PSSTATS_JS;
        }
    ...
    public function update()
    {
        ...
        // we need to make sure to sync psstats.js / piwik.js
        $this->updateAlternative('piwik.js', 'psstats.js', $newContent);
        $this->updateAlternative('psstats.js', 'piwik.js', $newContent);
    }
