...
class UpdateTracker extends ConsoleCommand
{
    protected function configure()
    {
        ...
        $this->setAliases(array('custom-psstats-js:update'));
        ...
        $this->addOption('target-file', null, InputOption::VALUE_REQUIRED, 'Absolute path to target file. Useful if your /psstats.js is not writable and you want to replace the file manually', PIWIK_DOCUMENT_ROOT . TrackerUpdater::TARGET_PSSTATS_JS);
