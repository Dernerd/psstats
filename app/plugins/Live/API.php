...
/**
 * The Live! API lets you access complete visit level information about your visitors. Combined with the power of <a href='http://psstats.org/docs/analytics-api/segmentation/' target='_blank'>Segmentation</a>,
 ...
 *
 * With the parameter <a href='http://psstats.org/docs/analytics-api/segmentation/' rel='noreferrer' target='_blank'>'&segment='</a> you can filter the
 ...
 *
 * See also the documentation about <a href='http://psstats.org/docs/real-time/' rel='noreferrer' target='_blank'>Real time widget and visitor level reports</a> in Psstats.
