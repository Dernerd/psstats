...
/**
 * The ImageGraph.get API call lets you generate beautiful static PNG Graphs for any existing Psstats report.
 ...
 * - $colors accepts a comma delimited list of colors that will overwrite the default Psstats colors <br/>
 ...
 *
 * See also <a href='https://developer.psstats.org/api-reference/reporting-api-metadata#static-image-graphs'>How to embed static Image Graphs?</a> for more information.
 *
...
class API extends \Piwik\Plugin\API
{
    ...
    )
    {
        ...
        if (!SettingsServer::isGdExtensionEnabled()) {
            throw new Exception('Error: To create graphs in Psstats, please enable GD php extension (with Freetype support) in php.ini,
