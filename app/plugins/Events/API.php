 ...
 *
 * Events are tracked using the Javascript Tracker trackEvent() function, or using the [Tracking HTTP API](http://developer.psstats.org/api-reference/tracking-api).
 *
