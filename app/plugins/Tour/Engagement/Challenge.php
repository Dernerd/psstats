...
/**
 * Defines a new challenge which a super user needs to complete in order to become a "Psstats expert".
...
abstract class Challenge
{
    ...
    /**
     * A URL that has more information about how to complete the given event or a URL within the Psstats app to directly
