    ...
    initialize: function(options) {
        ...
        function getQueue() {
            return new Promise(function(resolve, reject) {
                ...
                var request = indexedDB.open("psstats", 1);
        ...
        self.addEventListener('fetch', function(event) {
            ...
            let isTrackingRequest = (event.request.url.includes('/psstats.php') ||
                event.request.url.includes('/piwik.php'));
            let isTrackerRequest = event.request.url.endsWith('/psstats.js') ||
            ...
            if (isTrackerRequest) {
                ...
                caches.open('psstats').then(function(cache) {
