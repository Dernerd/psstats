...
[![Latest Stable Version](https://poser.pugx.org/psstats/device-detector/v/stable)](https://packagist.org/packages/psstats/device-detector)
[![Latest Unstable Version](https://poser.pugx.org/psstats/device-detector/v/unstable)](https://packagist.org/packages/psstats/device-detector)
[![Total Downloads](https://poser.pugx.org/psstats/device-detector/downloads)](https://packagist.org/packages/psstats/device-detector)
[![License](https://poser.pugx.org/psstats/device-detector/license)](https://packagist.org/packages/psstats/device-detector)

## Code Status

![PHPUnit](https://github.com/psstats-org/device-detector/workflows/PHPUnit/badge.svg?branch=master)
![PHPStan](https://github.com/psstats-org/device-detector/workflows/PHPStan%20check/badge.svg?branch=master)
![PHPCS](https://github.com/psstats-org/device-detector/workflows/PHPCS%20check/badge.svg?branch=master)
![YAML Lint](https://github.com/psstats-org/device-detector/workflows/YAML%20Lint/badge.svg?branch=master)
[![Average time to resolve an issue](http://isitmaintained.com/badge/resolution/psstats-org/device-detector.svg)](http://isitmaintained.com/project/psstats-org/device-detector "Average time to resolve an issue")
[![Percentage of issues still open](http://isitmaintained.com/badge/open/psstats-org/device-detector.svg)](http://isitmaintained.com/project/psstats-org/device-detector "Percentage of issues still open")
...
Using DeviceDetector with composer is quite easy. Just add `psstats/device-detector` to your projects requirements.

```
composer require psstats/device-detector
```
...
```
zcat ~/path/to/access/logs* | awk -F'"' '{print $6}' | sort | uniq -c | sort -rn | head -n20000 > /home/psstats/top-user-agents.txt
```

### Contributors
Created by the [Psstats team](http://psstats.org/team/), Stefan Giehl, Matthieu Aubry, Michał Gaździk,
...
See also: [QA at Psstats](http://psstats.org/qa/)
