...
This regex would match an url like 'http://searchengine.com/search/web/psstats'
...
For the configuration above the generated backlink would look like `searchengine.com/search?q=psstats` (assuming that `psstats` is the keyword).
...
We welcome your contributions and Pull requests at [github.com/psstats-org/searchengine-and-social-list](https://github.com/psstats-org/searchengine-and-social-list/edit/master/README.md)! 
