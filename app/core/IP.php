 ...
 *
 * @see \Psstats\Network\IP
 * @see \Psstats\Network\IPUtils
 * @link https://github.com/psstats-org/component-network
 *
    ...
    public static function getFirstIpFromList($csv, $excludedIps = null)
    {
        ...
        if ($p !== false) {
            ...
            foreach ($elements as $ipString) {
                ...
                $ip = \Psstats\Network\IP::fromStringIP(IPUtils::sanitizeIp($element));
