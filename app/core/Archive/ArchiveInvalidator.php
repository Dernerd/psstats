...
class ArchiveInvalidator
{
    ...
    {
        // we're not using deleteLike since it maybe could cause deadlocks see https://github.com/psstats-org/psstats/issues/15545
                                              ...
                                              $forceInvalidateNonexistantRanges = false, $name = null, $ignorePurgeLogDataDate = false)
    {
        ...
        /**
         * Triggered when a Psstats user requested the invalidation of some reporting archives. Using this event, plugin
