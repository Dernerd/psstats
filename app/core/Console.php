...
class Console extends Application
{
    ...
    public function __construct(Environment $environment = null)
    {
        ...
        parent::__construct('Psstats', Version::VERSION);

        $this->environment = $environment;

        $option = new InputOption('psstats-domain',
            null,
            InputOption::VALUE_OPTIONAL,
            'Psstats URL (protocol and domain) eg. "http://psstats.example.org"'
        );
    ...
    protected function initPsstatsHost(InputInterface $input)
    {
        $psstatsHostname = $input->getParameterOption('--psstats-domain');

        if (empty($psstatsHostname)) {
            $psstatsHostname = $input->getParameterOption('--url');
        }

        $psstatsHostname = UrlHelper::getHostFromUrl($psstatsHostname);
        Url::setHost($psstatsHostname);
    }
