...
class Url
{
    ...
    private static function redirectToUrlNoExit($url)
    {
        ...
        if (Common::isPhpCliMode()) {
            throw new Exception("If you were using a browser, Psstats would redirect you to this URL: $url \n\n");
        }
    }
    ...
    {
        if (!class_exists("Psstats\\Network\\IPUtils")) {
            throw new Exception("Psstats\\Network\\IPUtils could not be found, maybe you are using Psstats from git and need to update Composer. $ php composer.phar update");
        }
