...
abstract class ControllerAdmin extends Controller
{
    ...
    private static function notifyIfEAcceleratorIsUsed()
    {
        ...
        $message = sprintf("You are using the PHP accelerator & optimizer eAccelerator which is known to be not compatible with Psstats.
            We have disabled eAccelerator, which might affect the performance of Psstats.
            Read the %srelated ticket%s for more information and how to fix this problem.",
            '<a rel="noreferrer noopener" target="_blank" href="https://github.com/psstats-org/psstats/issues/4439">', '</a>');
    ...
    /**
     * PHP Version required by the next major Psstats version
     * @return string
     */
    ...
    {
        return "Psstats " . Version::VERSION;
    }
