...
abstract class Controller
{
    ...
    public static function setHostValidationVariablesView($view)
    {
        ...
        if (!$view->isValidHost) {
            ...
            $view->invalidHostMessageHowToFix = '<p><b>How do I fix this problem and how do I login again?</b><br/> The Psstats Super User can manually edit the file piwik/config/config.ini.php
                                    ...
                                    $defaultDate = null, $parameters = array())
    {
        ...
        if (Piwik::hasUserSuperUserAccess()) {
            ...
            $message = "Error: no website was found in this Psstats installation.
			<br />Check the table '$siteTableName' in your database, it should contain your Psstats websites.";
        ...
        if (!Piwik::isUserIsAnonymous()) {
            ...
            $errorMessage  = sprintf(Piwik::translate('CoreHome_NoPrivilegesAskPiwikAdmin'), $currentLogin, "<br/><a href='mailto:" . $emails . "?subject=Access to Psstats for user $currentLogin'>", "</a>");
    ...
    protected function checkSitePermission()
    {
        if (!empty($this->idSite)) {
            ...
            throw new Exception("The requested website idSite is not found in the request, or is invalid.
				Please check that you are logged in Psstats and have permission to access the specified website.");
        }
    }
