...
class Config
{
    ...
    public function forceUsageOfLocalHostnameConfig($hostname, $preferredPath = null)
    {
        ...
        throw new Exception('Psstats domain is not a valid looking hostname (' . trim($fileNames) . ').');
    }
    ...
    public function dumpConfig()
    {
        ...
        $header .= "; file automatically generated or modified by Psstats; you can manually override the default values in global.ini.php by redefining them in this file.\n";
