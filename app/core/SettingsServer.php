...
class SettingsServer
{
    ...
    /**
     * Returns true if Psstats is running within Psstats for WordPress.
     *
     * @return bool  true if Psstats is running in WordPress, false if Psstats is running as part of On-Premise
     * @api
     */
    public static function isPsstatsForWordPress()
    {
