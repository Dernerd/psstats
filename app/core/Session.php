...
{
    const SESSION_NAME = 'PSSTATS_SESSID';
    ...
    public static function start($options = false)
    {
        ...
        // to preserve previous behavior psstats_auth provided when it contained a token_auth, we ensure
        ...
        if (!SettingsPiwik::isPsstatsInstalled()) {
            ...
            // as of Psstats 3.7.0 we only support files session handler during installation
