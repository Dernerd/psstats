...
class Cookie
{
    ...
    protected function loadContentFromCookie()
    {
        ...
        if ($cookieStr === false
            ...
            // cookie was set since Psstats 4
        ...
        foreach ($values as $nameValue) {
            ...
            if (!is_numeric($varValue)) {
                ...
                if ($isSigned) {
                    // only unserialise content if it was signed meaning the cookie was generated pre Psstats 4
                ...
                // can only happen when it was signed pre Psstats 4
