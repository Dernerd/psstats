 ...
 * One request to the psstats.php script is associated to one action.
 *
 */
class Visit implements VisitInterface
{
    ...
    protected function handleExistingVisit($visitIsConverted)
    {
        ...
        foreach ($this->requestProcessors as $processor) {
            ...
            // Refs https://github.com/psstats-org/psstats/issues/17173
    ...
    protected function updateExistingVisit($valuesToUpdate)
    {
        ...
        if ($wasInserted) {
            ...
            // mostly for WordPress. see https://github.com/psstats-org/psstats/pull/15587
