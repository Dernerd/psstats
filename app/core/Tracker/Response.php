...
class Response
{
    ...
    public function outputException(Tracker $tracker, Exception $e, $statusCode)
    {
        ...
        if ($tracker->isDebugModeEnabled()) {
            ...
            $headerPage = str_replace('{$HTML_TITLE}', 'Psstats &rsaquo; Error', $headerPage);
    ...
    protected function getMessageFromException($e)
    {
        ...
        if ($e->getCode() == 1044 || $e->getCode() == 42000) {
            return "Error while connecting to the Psstats database - please check your credentials in config/config.ini.php file";
        }
    ...
    {
        error_log(sprintf("Error in Psstats (tracker): %s", str_replace("\n", " ", $this->getMessageFromException($e))));
    }
}
