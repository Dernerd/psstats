...
{
    const OPTION_NAME_PSSTATS_INSTALL_VERSION = 'install_version';
    ...
    public function getTablesInstalled($forceReload = true)
    {
        if (is_null($this->tablesInstalled)
            ...
            /**
             * Triggered when detecting which tables have already been created by Psstats.
    ...
    /**
     * Records the Psstats version a user used when installing this Psstats for the first time
     */
    public function recordInstallVersion()
    {
        if (!self::getInstallVersion()) {
            Option::set(self::OPTION_NAME_PSSTATS_INSTALL_VERSION, Version::VERSION);
        }
    }

    /**
     * Returns which Psstats version was used to install this Psstats for the first time.
     */
    public function getInstallVersion()
    {
        Option::clearCachedOption(self::OPTION_NAME_PSSTATS_INSTALL_VERSION);
        $version = Option::get(self::OPTION_NAME_PSSTATS_INSTALL_VERSION);
        if (!empty($version)) {
            return $version;
        }
    }
