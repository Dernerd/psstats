...
class Cache
{
     ...
     *
     * @return \Psstats\Cache\Lazy
     */
    public static function getLazyCache()
    {
        return StaticContainer::get('Psstats\Cache\Lazy');
    }
     ...
     *
     * @return \Psstats\Cache\Transient
     */
    public static function getTransientCache()
    {
        return StaticContainer::get('Psstats\Cache\Transient');
    }
     ...
     *
     * @return \Psstats\Cache\Eager
     */
    public static function getEagerCache()
    {
        return StaticContainer::get('Psstats\Cache\Eager');
    }
